...
header.textContent = "Dynamic Product Card Creation Using JavaScript Object Data";
...
for (let i = 0; i < obj.length; i++) {
    ...
    card.style.boxShadow="0 0 2px black "
    card.style.padding="15px"
    card.addEventListener("mouseover",()=>{
card.style.boxShadow="0 0 20px black";
card.style.transform="scale(1.002)";
    ...
    category.style.padding="10px 0px"
